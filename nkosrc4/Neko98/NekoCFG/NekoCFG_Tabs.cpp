...
BOOL CALLBACK PropPage_Display( HWND hPage, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
    ...
    {
        case WM_INITDIALOG:
            SendDlgItemMessage( hPage, IDC_SCALESLIDER, TBM_SETRANGE, FALSE, MAKELPARAM(MIN_SCALE,MAX_SCALE) );
            break;

        case MY_WRITESETTINGS:
            g_lpCurrentCat->uScale = SendDlgItemMessage( hPage, IDC_SCALESLIDER, TBM_GETPOS, 0, 0 );
        ...
        case MY_READSETTINGS:
            SendDlgItemMessage( hPage, IDC_SCALESLIDER, TBM_SETPOS, TRUE, g_lpCurrentCat->uScale );
        ...
        case WM_HSCROLL:
        {
            ...
            char szBuffer[32];
            sprintf( szBuffer, "%d%%", SendDlgItemMessage( hPage, IDC_SCALESLIDER, TBM_GETPOS, 0, 0 ) );
        ...
        case WM_COMMAND:
            ...
            {
                case IDC_SET100:
                    SendDlgItemMessage( hPage, IDC_SCALESLIDER, TBM_SETPOS, TRUE, 100 );
                    SendMessage( hPage, WM_HSCROLL, 0, 0 );
                    break;
